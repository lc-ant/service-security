...
@LcAntServiceClient(service = "${lc-ant.services.security:security-service}", qualifier = "securityServiceRestClientV1Secrets")
public interface SecurityServiceClientV1Secrets extends SecurityServiceSecrets {

	@PostExchange("/{subjectType}/{subjectId}/{tenantId}")
	@Override
	Mono<Void> setSecret(
	...
	@PutExchange("/{subjectType}/{subjectId}/{tenantId}")
	@Override
